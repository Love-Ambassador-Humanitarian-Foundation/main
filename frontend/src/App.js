  ...
  return (
    <Router>
          <Routes>
            ...
            <Route path="/admin/branches/:name" element={<PrivateRoute redirectUrl={"/admin/branches/:id"} API_URL={API_URL} ><AdminMain API_URL={API_URL} Companyname={Companyname} screen={<Branch API_URL={API_URL} />} /></PrivateRoute>} />
