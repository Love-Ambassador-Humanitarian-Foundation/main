...
import { TwitterOutlined, InstagramOutlined, FacebookOutlined, WhatsAppOutlined, LinkedinOutlined } from '@ant-design/icons';
        ...
        <Container fluid style={style}>
            <footer className="py-5">
                ...
                <div className="d-flex flex-column flex-sm-row justify-content-between align-items-center border-top mt-4 pt-3">
                    <p className='text-dark text-center m-0' style={{ flexGrow: 1 }}>© {currentYear} {Companyname}, Inc. All rights reserved.</p>
                </div>
            </footer>
        </Container>
    );
