...
# Generated by Django 4.2.15 on 2024-09-07 07:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0004_remove_newsletter_media_remove_newsletter_sender'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='user',
            options={'ordering': ['-last_login', '-joined_at', 'firstname', 'lastname']},
        ),
